...
import com.blorbee.drowneddepths.block.custom.PedestalBlock;
...
public class ModBlocks {
    ...
    public static final Block PEDESTAL = register("pedestal", PedestalBlock::new, AbstractBlock.Settings.create().nonOpaque());
